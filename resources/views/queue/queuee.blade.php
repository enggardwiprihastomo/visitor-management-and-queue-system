...
<body>
			...
			<tr>
				...
				<td class="datetimeterminal">
					...
					<div class="divterminal">
						<div id="terminal" class="terminalname"></div>
		...
		<table>
			<tr>
				<td class="activequeue">
					<div class="tablequeue">
						<div class="tablequeuedesc">Meja</div>
						<div class="tablequeuenumber">
							<select id="counter" name="tablenumber">
								<option value="1">E1 Konsultasi Pajak</option>
								<option value="2">E2 Konsultasi Aplikasi Pajak</option>
							</select>
						</div>
					</div>
				</td>
			...
			<tr>
				...
				<td class="remainingqueue">
					<img src="{{ asset('asset/queueleft.png') }}"> Antrian Tersisa: <b id="remainingQueue">298</b>
				</td>
			</tr>
		</table>
	</div>
    ...
    <script src="{{ asset('js/queuee.js') }}"></script>
</body>
</html>