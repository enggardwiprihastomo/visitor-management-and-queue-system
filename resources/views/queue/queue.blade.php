			...
			<tr>
				...
				<td class="datetimeterminal">
					...
					<div class="divterminal">
						<div id="terminalCounter" class="terminalname"></div>
		...
		<table>
			<tr>
				<td class="activequeue">
					<div class="callingqueue">
						<div class="callingqueuedesc">Antrian Aktif</div>
						<div id="currentQueue" class="callingqueuenumber"></div>
					</div>
				</td>
				<td class="queuehistory" rowspan="2">
					<div class="callinghistory">
						<table>
							<thead>
                                <tr>
